...
import { Camera, CameraAlt, CameraAltOutlined } from "@mui/icons-material";

// export const metadata = {
//   title: "Admin Profile | Admin - profile",
//   description:
//     "",
// };
...
const Profile = () => {
  return (
    <AdminLayout>
        <Box className="mx-auto max-w-242.5">
            <Breadcrumb pageName="Profile" />
            <Box className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <Box className="relative z-20 h-35 md:h-65">
                    <Image
                    src={"/admin-panel/cover-01.png"}
                    alt="profile cover"
                    ...
                    />
                    <Box className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
                    <label
                ...
                <Box className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <Box className="relative z-30 mx-auto -mt-22 h-30 max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                        <Box className="relative drop-shadow-2">
                            <Image
                                src={"/admin-panel/user-06.png"}
                                width={160}
                                height={160}
                                style={{
                                    width: "auto",
                    ...
                    {/* <Box className="mt-4">
                        ...
                        <Box className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                            <Box className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                            ...
                            <Box className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                            <span className="font-semibold text-black dark:text-white">
                                2K
                            </span>
