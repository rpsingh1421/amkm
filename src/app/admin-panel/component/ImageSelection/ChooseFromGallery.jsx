...
const ChooseFromGallery = (props) => {
    const {updateImageFilePath,selectedimage,action,closeDialog,sectionId} =props;
     //selectedImage: this will contain information of image which has to be changed..and it comes as props
    ...
    const changeImageHandler =async()=>{
      ...
      if (action == 'add') {
        ...
        updateImageFilePath(newSelectedImage);
        setNewSelectedImage();
        closeDialog();
        ...
        console.log("selected section :",selectedimage)
         try {
          const response= await axios.put(`/rest-api/home-page/${sectionId}`,{[selectedimage]:newSelectedImage});
