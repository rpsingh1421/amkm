...
const page = () => {
  return (
    <MainLayout>
      <Box>
        <Image width={1000} height={100} src="/founder_bg.png" alt="founder_bg.png" className="w-full"/>
        <Box className="w-[90%] m-auto p-[3%]">
            <Box className="lg:flex gap-[2%]">
                <Box className="lg:w-1/3">
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag1.jpg" alt="founder_anurag" className="rounded-xl w-full"/>
                </Box>
            ...
            <Box className="lg:flex gap-[2%]">
                ...
                <Box className="sm:w-1/3">
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag2.jpg" alt="founder_anurag" className="rounded-xl mt-[3%] w-full"/>
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag6.jpg" alt="founder_anurag" className="rounded-xl mt-[3%] w-full"/>
                </Box>
            </Box>
            <Box className="lg:flex gap-[2%]">
                <Box className="sm:w-1/3">
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag3.jpg" alt="founder_anurag" className="rounded-xl w-full"/>
                </Box>
                <Box className="lg:w-2/3">
            ...
            <Box className="lg:flex gap-[2%]">
                ...
                <Box className="sm:w-1/3">
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag4.jpg" alt="founder_anurag" className="rounded-xl w-full"/>
                </Box>
            </Box>
            ...
            <Box className="lg:flex gap-[2%]">
                <Box className="sm:w-1/3">
                    <Image width={300} height={100} src="/founder/founder_amkm_anurag5.jpg" alt="founder_anurag" className="rounded-xl w-full"/>
                </Box>
                <Box className="lg:w-2/3">
