...
const AllImage = () => {
  ...
  const fetchAllActiveImageCount = async () => {
    try {
      const response = await axios.get('/rest-api/photo-gallery/pagination?status=true&category=newspaper');
  ...
  const fetchImages = async () => {
    ...
    try {
      const imageListResponse = await axios.get(`/rest-api/photo-gallery/pagination/${block}/${items}?status=true&category=newspaper`);
