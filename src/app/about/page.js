    ...
    <MainLayout>
      ...
      <Paper className="my-[2%] py-[2%]">
        ...
        <Box className="sm:flex w-[90%] gap-[2%] m-auto">
          ...
          <Box className="sm:w-1/2">
            <Image width={1000} height={100} src="/aboutimg1.png" alt="about_image" className="rounded-xl w-full"/>
          </Box>
        </Box>
      </Paper>
      <Paper className="sm:flex gap-[3%] p-[3%]">
        <Paper className="sm:w-1/3">
          <Image width={1000} height={100} src="/project-work/p61_image.png" alt="vision_img" className="w-full h-1/3"/>
          <Box className="p-[3%]">
         ...
         <Paper className="sm:w-1/3">
          <Image width={1000} height={100} src="/project-work/p77_image.png" alt="" className="w-full h-1/3"/>
          <Box className="p-[3%]">
         ...
         <Paper className="sm:w-1/3">
          <Image width={1000} height={100} src="/project-work/p93_image.jpg" alt="" className="w-full h-1/3"/>
          <Box className="p-[3%]">
      ...
      <Paper className="hidden sm:block my-[2%] py-[2%] pb-0">
        ...
        <Box className="flex w-[90%] gap-[2%] m-auto">
          <Box className="w-1/2">
            <Image width={500} height={100} src="/project-work/p49_image.png" alt="p49_image" className="rounded-xl h-[85%] w-full"/>
          </Box>
          <Box className="w-1/2">
      ...
      <Paper className="my-[2%] py-[2%]">
        ...
        <Box className="sm:flex w-[90%] gap-[2%] m-auto">
          <ShortStory/>         
          <Box className="sm:w-1/2">
            <Image width={500} height={100} src="/project-work/p19_image.png" alt="about_image" className="rounded-xl w-full"/>
          </Box>
        </Box>
      </Paper>
      <GIveUsHand/>
